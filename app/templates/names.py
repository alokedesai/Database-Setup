...
data = [
    ...
    {
      "name": "Hamada Taher Kattaria", 
      "education": [
        {
          "school": {
            "id": "108019575887836", 
            "name": "College de la Sainte Famille"
          }, 
          "type": "High School"
        }, 
        {
...
for datum in data:
    ...
    u = User(datum["name"].replace(" ",""),datum["name"],datum["education"],college,datum["name"].replace(" ","")+"@apployment.com","password")
    db.session.add(u)
db.session.commit()
